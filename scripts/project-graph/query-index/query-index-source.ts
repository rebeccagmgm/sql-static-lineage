...
function assertCausalReferencesSources(
  ...
  if (
    ...
    snapshot.projectSource.manifestContentHash !== topology.manifest.contentHash ||
    snapshot.projectSource.manifestSha256 !== topologyIdentity.files.manifest.sha256 ||
    snapshot.projectSource.snapshotSha256 !== topologyIdentity.files.snapshot.sha256 ||
    snapshot.projectSource.nodesSha256 !== topologyIdentity.files.nodes.sha256 ||
