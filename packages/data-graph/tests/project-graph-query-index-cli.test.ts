...
describe("query-index CLI safety", () => {
  ...
  it("keeps normal pipeline, Phase 1/2 publication and file-query modules free of Neo4j initialization", () => {
    const paths = [
      ...
      "src/project-graph/query/project-topology-query.ts",
      "src/project-graph/field-evidence/field-evidence-publication.ts",
      "src/project-graph/field-evidence/field-evidence-query.ts",
    ];
