with Init_Nom_Prin as(
    ...
    and Strt_Pric_Date between '${yyyy-MM}-01' and '${yyyy-MM-dd}'
)

SELECT grp.grp_id AS grp_id, index.index_val, from_unixtime(unix_timestamp(),'yyyy-MM-dd HH:mm:ss') data_time, 'wxliangjiaqi' modify_operator, '2999-12-31 00:00:00' modify_time, '1' status, 'ind2024091113603751' index_id, index.busi_date busi_date, tag_id FROM (
