...
-- source: LOCAL_CODE
-- sqlStatus: AVAILABLE
-- scriptPath: BigData-GF_FDM_N/REF/PDATA_N.T99_DERI_COMP_BASE_COEF_REF_OIS012.py
-- observed_at: 2026-09-05T01:06:53.159Z
...
-----------------------------------------------------------------------------------------------------
--Group1: Source Table:[ODATA_N_OIS.O_CONTRACT_BASE_RATE:销售收入交叉销售合约基础系数表]
-----------------------------------------------------------------------------------------------------
SELECT
    ...
    ,A.BASE_AWARD_RATE                       AS  Base_Yield              --基础收益率
    ,''                                      AS  Dft_Base_Coef           --拟定基础系数
    ...
    ,A.ADDITIONAL_REWARD                     AS  Adtnl_Rwd               --额外奖励
