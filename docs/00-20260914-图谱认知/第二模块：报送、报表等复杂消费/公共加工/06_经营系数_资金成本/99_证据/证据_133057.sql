...
-- source: LOCAL_CODE
-- sqlStatus: AVAILABLE
-- scriptPath: BigData-GF_FDM_N/REF/PDATA_N.T99_DERI_COMP_TYPE_FND_COST_REF_OIS014.py
-- observed_at: 2026-09-05T01:06:53.172Z
...
-----------------------------------------------------------------------------------------------------
--Group1: Source Table:[ODATA_N_OIS.G_BUS_TYPE_CAPITAL_COST:销售收入合约类型资金成本利率表]
-----------------------------------------------------------------------------------------------------
SELECT
