...
已记录固定发布 SQL 核读的任务 2858 项；另有 97 项记录当前 Input Pack 补充 SQL 核读。两类可能重叠。补充来源独立验证 task.json 声明、采集时间、文件哈希与行段，不视为原发布中的 SQL 或新增图边。
...
| 记录状态 | 不重复任务数 | 含义 |
|---|---:|---|
| 至少有一处业务解释 | 1745 | 以具体审阅页声明的范围为准，未承诺全字段、全部消费或运行正确 |
...
| 尚无合并后的主题审阅记录 | 368 | 继续研究；名称分类不能替代解释 |
...
| [aml-customer-funds-and-controls](aml-review.json) | 15 | FAMILY_RULES_EXPLAINED 15 |
...
[完整逐任务记录](content-ledger-19-reviews.json) · [固定范围与证据状态](scope-summary.md) · [知识库入口](../README.md)
