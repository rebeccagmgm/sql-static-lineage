...
const DERIVATION_ROOTS = [
  ...
  join(REPO_ROOT, "scripts/addons/task-lineage/project-graph/field-evidence-v1/field-edge-index.ts"),
  join(REPO_ROOT, "scripts/addons/task-lineage/project-graph/field-evidence-v1/resolve-read-field.ts"),
  join(REPO_ROOT, "scripts/addons/task-lineage/project-graph/field-evidence-v1/control-scope.ts"),
  join(REPO_ROOT, "scripts/addons/task-lineage/project-graph/field-evidence-v1/impact-query.ts"),
  join(REPO_ROOT, "scripts/addons/task-lineage/project-graph/field-evidence-v1/impact-result-contract.ts"),
  join(REPO_ROOT, "scripts/addons/task-lineage/project-graph/field-evidence-v1/schedule-preference.ts"),
  join(REPO_ROOT, "scripts/addons/task-lineage/project-graph/field-evidence-v1/continuation"),
